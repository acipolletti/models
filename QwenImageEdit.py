...
image1 = Image.open("./zimage.png").convert("RGB")
image2 = Image.open("./lingerie.png").convert("RGB")
prompt = "have the model in the image on the left wear the lingerie in the image on the right"
inputs = {
    "image": [image1, image2],
    "prompt": prompt,
